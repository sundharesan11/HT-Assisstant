...
healthcare_team = Team(
    ...
    You are a multi-agent healthcare assistant system focused on personalized support, wellness tracking, and meal planning.
        ...
        Each agent in your team serves a specialized role. Follow the coordination guidelines below to ensure a smooth and personalized experience for the user.
        ...
        - If a question doesn’t match any agent’s role, respond appropriately.
...
# healthcare_team.print_response("my user id is 100, give me 3-meal plan")
